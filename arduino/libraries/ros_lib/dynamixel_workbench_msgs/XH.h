#ifndef _ROS_dynamixel_workbench_msgs_XH_h
#define _ROS_dynamixel_workbench_msgs_XH_h
...
namespace dynamixel_workbench_msgs
{
  ...
  class XH : public ros::Msg
  {
    ...
    const char * getType(){ return "dynamixel_workbench_msgs/XH"; };
