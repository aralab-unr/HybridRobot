#ifndef _ROS_dynamixel_workbench_msgs_EX_h
#define _ROS_dynamixel_workbench_msgs_EX_h
...
namespace dynamixel_workbench_msgs
{
  ...
  class EX : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 0) = (this->Sensored_Current >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (this->Sensored_Current >> (8 * 1)) & 0xFF;
      offset += sizeof(this->Sensored_Current);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += sizeof(this->Punch);
      this->Sensored_Current =  ((uint16_t) (*(inbuffer + offset)));
      this->Sensored_Current |= ((uint16_t) (*(inbuffer + offset + 1))) << (8 * 1);
      offset += sizeof(this->Sensored_Current);
     return offset;
    }

    const char * getType(){ return "dynamixel_workbench_msgs/EX"; };
    const char * getMD5(){ return "49929b8e4c95abff8543ee349bf2dc0b"; };
