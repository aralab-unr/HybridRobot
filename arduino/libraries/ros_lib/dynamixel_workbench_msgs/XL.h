#ifndef _ROS_dynamixel_workbench_msgs_XL_h
#define _ROS_dynamixel_workbench_msgs_XL_h
...
namespace dynamixel_workbench_msgs
{
  ...
  class XL : public ros::Msg
  {
    ...
    const char * getType(){ return "dynamixel_workbench_msgs/XL"; };
    const char * getMD5(){ return "ea49a2701ed85afc888c2c84aca6af1f"; };
