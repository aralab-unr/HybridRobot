#ifndef _ROS_dynamixel_workbench_msgs_MXExt_h
#define _ROS_dynamixel_workbench_msgs_MXExt_h
...
namespace dynamixel_workbench_msgs
{
  ...
  class MXExt : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 0) = (this->Torque_Control_Mode_Enable >> (8 * 0)) & 0xFF;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += sizeof(this->Current);
      this->Torque_Control_Mode_Enable =  ((uint8_t) (*(inbuffer + offset)));
      offset += sizeof(this->Torque_Control_Mode_Enable);
    ...
    const char * getType(){ return "dynamixel_workbench_msgs/MXExt"; };
    const char * getMD5(){ return "2fbd27c9b5d24a5196a094d168160140"; };
