#ifndef _ROS_dynamixel_workbench_msgs_RX_h
#define _ROS_dynamixel_workbench_msgs_RX_h
...
namespace dynamixel_workbench_msgs
{
  ...
  class RX : public ros::Msg
  {
    ...
    const char * getType(){ return "dynamixel_workbench_msgs/RX"; };
    const char * getMD5(){ return "2995886198dd0136a45c431a45ec13b2"; };
